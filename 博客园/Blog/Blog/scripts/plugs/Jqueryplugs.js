...
$(".headerlitools_ulinfo").hide();
$(".icon-caret-down").click(function() {
    $(".headerlitools_ulinfo").toggle();
...
$.extend({
    ...
    jq_MaskDiv: function() {
        ...
        $.win().$('.theme-popover-mask').height($(document).height());
    },
    jq_MaskDiv_close: function() {
        $.win().$('.theme-popover-mask').hide();
    },
    /*确定取消对话框*/
    jq_Confirm: function(e) {
        ...
        $('.jq_dvconfirm').css("left", ($.win().$(document).width() - $.win().$('.jq_dvconfirm').width()) / 2 + "px");
        $('.jq_dvconfirm').css("top", 0 - $('.jq_dvconfirm').height());
        $('.jq_dvconfirm').stop().animate({ "top": 20 + $.win().$(window).scrollTop(), "opacity": 1 }, 350);
    ...
    jq_Alert: function(e) {
        ...
        $.win().$('.jq_dvalert').css("left", ($.win().$(document).width() - $('.jq_dvalert').width()) / 2 + "px");
        $.win().$('.jq_dvalert').css("top", 0 - $('.jq_dvalert').height());
        $.win().$('.jq_dvalert').stop().animate({ "top": 20 + $.win().$(window).scrollTop(), "opacity": 1 }, 350);
    ...
    jq_Loading: function() {
        ...
        $.win().$('.jq_dvloading').css("left", ($.win().$(document).width() - $.win().$('.jq_dvloading').width()) / 2 + "px");
        $.win().$('.jq_dvloading').css("top", 0 - $('.jq_dvloading').height());
        $.win().$('.jq_dvloading').stop().animate({ "top": 20 + $.win().$(window).scrollTop(), "opacity": 1 }, 350);
    },
    /*加载对话框     关闭*/
